...
\begin{table}[H]
    ...
    \scalebox{1.1}{
        \begin{tabular}{|c|c|c|c|c|c|}
            ...
            21   & 传热管内径       & $ d_i $             & $ Pa $    & 选定                                                                                               & 0.0192           \\ \hline
            22   & 单管流通面积     & $ a $               & $ ^oC $   & $ \frac{1}{4} \pi d_{i}^{2} $                                                                      & $ 2.90*10^{-4} $ \\ \hline
            23   & U 型管数目       & $ n $               & $ ^oC $   & 结构设计定                                                                                         & 1828             \\ \hline
            24   & 一回路流通面积   & $ A $               & $ m^{2} $ & $ n \cdot a $                                                                                      & 0.5291           \\ \hline
...
\begin{table}[H]
    ...
    \scalebox{1.1}{
        \begin{tabular}{|c|c|c|c|c|c|}
            ...
            3    & 节 距              & $ t $             & $ m $ & 选定                                                              & 0.0308  \\ \hline
            4    & 最小U 型管节园直径 & $ D_{\text{节}} $ & $ m $ & $ 4t $                                                            & 0.1232  \\ \hline
            5    & 实际布管数         & $ n $             & 根    & 结构设计定                                                        & 1731    \\ \hline
...
\begin{table}[H]
    ...
    \scalebox{1.4}{
        \begin{tabular}{|c|c|c|c|c|c|}
            \hline
            序号 & 项目           & 符号               & 单位       & 公式及来源                                           & 数值              \\ \hline
            1    & 冷却剂平均比容 & $ \overline{v_1} $ & $ m^3/kg $ & 查表                                                 & $ 1.378*10^{-3} $ \\ \hline
            2    & 主管道计算流速 & $ u_{10}^{'} $     & $ m/s $    & 选取：$ 8 \sim 12 m/s $                              & 10                \\ \hline
            3    & 主管道计算内径 & $ d_{1i}^{'} $     & $ m $      & $ \sqrt{4 G_{1} \bar{v}_{1} / \pi u_{10}^{\prime}} $ & 0.609             \\ \hline
            4    & 主管道设计内径 & $ d_{1i} $         & $ m $      & 选取                                                 & 0.62              \\ \hline
            5    & 主管道设计流速 & $ u_{10} $         & $ m/s $    & $ 4 G_{1} \bar{v}_{1} / \pi d_{1 i}^{2} $            & 9.67              \\ \hline
            6    & 新蒸汽比容     & $ v_2 $            & $ m^3/kg $ & $ v^{\prime \prime} x+v^{\prime}(1-x) $              & 0.039             \\ \hline
            7    & 蒸汽管计算流速 & $ u_{2}^{'} $      & $ m/s $    & 选取：$ 30 \sim 40 m/s $                             & 37                \\ \hline
            8    & 蒸汽管计算内径 & $ d_{2i}^{'} $     & $ m $      & $ \sqrt{4 G_{2} \bar{v}_{2} / \pi u_{2}^{\prime}} $  & 0.411             \\ \hline
            9    & 蒸汽管设计内径 & $ d_{2i} $         & $ m $      & 选取                                                 & 0.42              \\ \hline
            10   & 蒸汽管设计流速 & $ u_2 $            & $ m/s $    & $ 4 G_{2} v_{2} / \pi d_{2 i}^{2} $                  & 35.527            \\ \hline
