\begin{table}[H]
    ...
    \scalebox{1.4}{
        \begin{tabular}{|c|c|c|c|c|c|}
            ...
            1    & 一回路放热量     & $ Q $          & $ kW $    & 给定                                                                                           &      \\ \hline
            2    & 一回路工作压力   & $ p_1 $        & $ Pa $    & 给定                                                                                           &      \\ \hline
            3    & 一回路水进口温度 & $ t_{1}^{'} $  & $ ^oC $   & 给定                                                                                           &      \\ \hline
            4    & 一回路水出口温度 & $ t_{1}^{''} $ & $ ^oC $   & 给定                                                                                           &      \\ \hline
            5    & 一回路水平均温度 & $ t_a $        & $ ^oC $   & $ \frac{1}{2} (t_{1}^{'} + t_{1}^{''}) $                                                       &      \\ \hline
            6    & 一回路水进口焓   & $ i_{1}^{'} $  & $ kJ/kg $ & 查表                                                                                           &      \\ \hline
            7    & 一回路水出口焓   & $ i_{1}^{''} $ & $ kJ/kg $ & 查表                                                                                           &      \\ \hline
            8    & 蒸发器热效率     & $ \eta  $      &           & 给定                                                                                           &      \\ \hline
            9    & 一回路水流量     & $ G_1 $        & $ kg/s $  & $ \mathrm{Q} / \eta \cdot\left(\mathrm{i}_{1}^{\prime}-\mathrm{i}_{1}^{\prime \prime}\right) $ &      \\ \hline
            10   & 二回路工作压力   & $ p_s $        & $ Pa $    & 给定                                                                                           &      \\ \hline
